        ...
        <section className="bg-[#f8f5f0] section-base">
          <div className="max-w-[1160px] mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-14 items-start">
            ...
            <div>
              ...
              <h2 className="font-bold text-[#253347] mb-8 leading-tight" style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.6rem, 3vw, 2.3rem)' }}>
              ...
              <div className="flex flex-col gap-6 mb-10">
                {includes.map((item) => (
                  <div key={item.title} className="flex gap-4 items-start">
                    ...
                    <div>
                      <h3 className="text-[0.95rem] font-bold text-[#253347] mb-1.5" style={{ fontFamily: 'var(--font-body)' }}>{item.title}</h3>
              ...
              <div className="bg-white rounded-2xl border border-[#e8e3dc] p-6 shadow-sm">
                ...
                <div className="flex flex-col gap-3">
                  <a href="mailto:carovalenciam@outlook.com" className="flex items-center gap-3 text-[0.88rem] text-[#253347] font-semibold hover:text-[#87c1b6] transition-colors group" style={{ fontFamily: 'var(--font-body)' }}>
                  ...
                  <a href="https://www.linkedin.com/in/gerentedemercadeo" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[0.88rem] text-[#253347] font-semibold hover:text-[#87c1b6] transition-colors group" style={{ fontFamily: 'var(--font-body)' }}>
                    <span className="w-9 h-9 rounded-xl bg-[#87c1b6]/12 group-hover:bg-[#87c1b6]/20 flex items-center justify-center flex-shrink-0 transition-colors">
            ...
            <div>
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                {[
                  { href: 'https://www.linkedin.com/in/gerentedemercadeo', label: 'LinkedIn', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="#253347"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z"/><circle cx="4" cy="4" r="2"/></svg> },
                  { href: 'tel:+57', label: 'Telefono', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#253347" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg> },
                  { href: 'mailto:carovalenciam@outlook.com', label: 'Email', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#253347" strokeWidth="2"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg> },
                ].map((item) => (
                  <a
                    key={item.label}
                    href={item.href}
                  ...
                  >
                    {item.icon}
                    <span
                      className="text-[0.62rem] font-bold text-[#253347]"
