      ...
      <main>
        ...
        <section className="bg-[#f8f6f3] dot-grid pt-28 pb-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p
              className="text-[0.95rem] text-[#6b6b6b] leading-relaxed max-w-xl mx-auto"
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            {posts.length === 0 ? (
              ...
              <div className="text-center py-20">
                ...
                <p
                  className="text-[0.9rem] text-[#6b6b6b] max-w-md mx-auto leading-relaxed mb-6"
                  style={{ fontFamily: 'var(--font-body)' }}
                >
                  ...
                  <article key={post._id} className="group flex flex-col card-hover">
                    <Link href={`/blog/${post.slug.current}`} className="block">
                      ...
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        <span className="text-[0.65rem] text-[#6b6b6b]" style={{ fontFamily: 'var(--font-body)' }}>
                      ...
                      {post.excerpt && (
                        <p
                          className="text-[0.8rem] text-[#6b6b6b] leading-relaxed line-clamp-2"
                          style={{ fontFamily: 'var(--font-body)' }}
                        >
                          {post.excerpt}
                        </p>
