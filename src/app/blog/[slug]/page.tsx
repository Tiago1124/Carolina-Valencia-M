      ...
      <main>
        ...
        <section className="bg-[#f8f6f3] pt-28 pb-10">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            {post.excerpt && (
              <p className="text-[1rem] text-[#5a6578] leading-relaxed mb-5" style={{ fontFamily: 'var(--font-body)' }}>
                {post.excerpt}
              </p>
            )}
            ...
            <div className="flex items-center gap-3 pb-6 border-b border-[#e6e6e6]">
              ...
              <div>
                ...
                <p className="text-[0.68rem] text-[#5a6578]" style={{ fontFamily: 'var(--font-body)' }}>
