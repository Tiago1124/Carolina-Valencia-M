    ...
    <section className="relative min-h-screen bg-[#f8f6f3] dot-grid overflow-hidden pt-16">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-12 min-h-screen items-center py-20">
        ...
        <div className="flex flex-col justify-center">
          <div className="eyebrow mb-6" style={{ color: "var(--teal-dark)" }}>Fabricando Ideas</div>
          ...
          <p
            className="text-[1rem] text-[#5a6578] leading-[1.85] max-w-[500px] mb-8"
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              >
                ...
                <span
                  className="text-[0.62rem] text-[#5a6578] tracking-wide text-center leading-tight mt-0.5"
                  style={{ fontFamily: 'var(--font-body)' }}
                >
                  {s.label}
                </span>
